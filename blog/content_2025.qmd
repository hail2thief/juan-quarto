---
title: "The year in *content*: 2025"
...
music |> 
  ...
  my_kbl(caption = "Top albums added to my Apple Music library in 2025")
```

- I obviously did not add VU this year, one of those unfortunate quirks of streaming services where you end up with ten versions of the same album, and then you have to delete them all and re-add the original so you can listen start to end. *VU* is one of my top five albums.
...
music |> 
  ...
  my_kbl(caption = "Favorite albums of the year")
```
...
books |> 
  ...
  scale_y_discrete(breaks = function(x) x[seq(0, length(x), by = 1)])
```
...
movies |> 
  ...
  my_kbl(caption = "My movie watching stats for the year")
```
...
- *Brian Wilson: I Just Wasn't Made for These Times*. Odd choice but I love Brian Wilson and was blown away by this doc, clearly made for fans, chock-full of little easter eggs. When I saw the Brian Wilson portrait my eyes popped out.
...
**The best movie that came out this year**: *Eddington*, funny and has something new to say about how technology mediates reality (also the pandemic that no one wants to remember).
